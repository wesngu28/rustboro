...
{#if show}
	<div>
		<h2>Click the Pokeball to search, click the Badge to play</h2>
		<img
			class="roxanne"
			alt="Roxanne, 1st gym leader in Ruby sapphire emerald"
			src="/roxanne.jpg"
		/>
		<h1>Rustboro Trainer's School</h1>
		<a href="https://github.com/wesngu28/rustboro">Github Repo</a>
		<p>
